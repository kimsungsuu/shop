...
public class ThymeleafExController {
    ...
    public String thymeleafEx06(String param1, String personalParam, Model model){
        model.addAttribute("param1", param1);
        model.addAttribute("personalParam", personalParam);
        return "thymeleafEx/thymeleafEx06";
    }

    @GetMapping(value="personalEx02")
    public String personalThymeleafEx02(String param1, String param2, Model model){
        model.addAttribute("param1", param1);
        model.addAttribute("param2", param2);
        return "thymeleafEx/thymeleafPersonalEx02";
    }
